class Card < ApplicationRecord
  ...
  # 消す# validates :all_card, presence: true, length: {maximum: 19} #3文字*5+4スペース
  # 消す# validates :first_card, presence: true, format: {with: VALID_CARD_REGEX}
  # 消す# before_validation :card_exist #用法間違っている？
